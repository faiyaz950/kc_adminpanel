...
const CAT_META = {
  ...
  marsiya:  { label: 'Marsiya',   color: '#7F1D1D', bg: 'rgba(127,29,29,.08)',  border: 'rgba(127,29,29,.2)',  icon: '📜' },
  soz: { label: 'Soz', color: '#D97706', bg: 'rgba(217,119,6,.08)', border: 'rgba(217,119,6,.2)', icon: '🌙' },
  salam: { label: 'Salam', color: '#F59E0B', bg: 'rgba(245,158,11,.08)', border: 'rgba(245,158,11,.2)', icon: '🤲' },
